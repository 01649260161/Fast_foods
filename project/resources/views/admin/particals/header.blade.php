        ...
        <ul class="nav pull-right top-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu extended logout">
                    ...
                    <li><a href="http://foods.local/admin/users/<?php if(isset(Auth::user()->id)){echo Auth::user()->id;}else{echo '1';}?>/edit"><i class=" fa fa-suitcase"></i>Hồ sơ</a></li>
                    <li><a href="http://foods.local/admin/config"><i class="fa fa-cog"></i> Cài đặt</a></li>
                    <li>
